...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Universal Interactive Attachment Manager with Upload Button & Multi-File Staging
    function initAttachmentGroup(group) {
        const picker = group.querySelector('.attachment-picker-input');
        const uploadBtn = group.querySelector('.btn-upload-attachment');
        ...
        if (!picker || !uploadBtn || !hiddenInput || !listContainer) return;
