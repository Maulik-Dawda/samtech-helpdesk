...
<div class="auth-page">
    ...
    <i class="bi bi-envelope-check security-icon icon-4"></i>
    ...
    <div class="container min-vh-100 d-flex flex-column align-items-center justify-content-center py-3">
        ...
        <div class="auth-card w-100 <?= $hasError ? 'shake' : ''; ?>" style="max-width:430px;">
            ...
            <form
                ...
                onsubmit="showSamtechLoader('Sending verification code...')">
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted d-block mt-2">
                        We will send a password reset OTP to your registered email address.
                    </small>
