...
<div class="container min-vh-100 d-flex align-items-center justify-content-center">
    <div class="auth-card w-100" style="max-width: 460px;">
        ...
        <div class="text-center mb-4">
            <h3 class="fw-bold">Verify Recovery OTP</h3>
            <p class="text-muted mb-0">Enter the OTP sent to your registered email.</p>
        </div>
        ...
        <form method="POST" action="<?= BASE_URL ?>/mfa-recovery-verify">
            <?= Csrf::field(); ?>
            ...
            <button type="submit" class="btn btn-primary-custom w-100 py-2 fw-semibold">
                Verify OTP & Reset Authenticator
            </button>
        </form>

        <div class="text-center mt-3">
            <a href="<?= BASE_URL ?>/mfa-recovery" class="text-decoration-none small">
                Back to recovery
            </a>
        </div>
