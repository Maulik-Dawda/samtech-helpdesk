...
<div class="auth-page">
    ...
    <i class="bi bi-envelope-check security-icon icon-2"></i>
    ...
    <div class="container min-vh-100 d-flex flex-column align-items-center justify-content-center py-3">
        ...
        <div class="auth-card w-100 <?= $hasError ? 'shake' : ''; ?>" style="max-width:430px;">
            ...
            <form
                method="POST"
                action="<?= BASE_URL ?>/forgot-password-verify"
            ...
            <div class="d-flex align-items-center justify-content-between mt-3 p-2 bg-light rounded-3 border">
                ...
                <form method="POST" action="<?= BASE_URL ?>/forgot-password-verify/resend" id="resendOtpForm" class="d-inline" onsubmit="handleResendSubmit(event)">
                    <?= Csrf::field(); ?>
