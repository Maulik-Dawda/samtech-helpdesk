        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center">
            <div>
                ...
                <p class="welcome-subtitle">
                    Track your support tickets and organization requests.
                </p>
            </div>

            <div class="organization-pill">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="stat-card stat-total">
                ...
                <div class="stat-trend">
                    <i class="bi bi-arrow-up-right"></i> Organization total
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-2 col-md-4 col-sm-6">
            <div class="stat-card stat-open">
                ...
                <div class="stat-trend">
                    <i class="bi bi-arrow-up-right"></i> Active tickets
                </div>
            </div>
        </div>
    ...
    <div class="row g-3">
        ...
        <div class="col-xl-9 col-lg-8">
            <div class="dashboard-card">
                <div class="dashboard-card-header">
                    ...
                    <a href="<?= BASE_URL ?>/tickets" class="view-all-btn">
                        View All Tickets
        ...
        <div class="col-xl-3 col-lg-4">
            <div class="quick-action-card">
                ...
                <a href="<?= BASE_URL ?>/tickets/create" class="quick-action-link">
                ...
                <a href="<?= BASE_URL ?>/tickets" class="quick-action-link">
                    <span class="quick-action-icon">
                        <i class="bi bi-ticket-detailed"></i>
                    </span>
                    View Tickets
